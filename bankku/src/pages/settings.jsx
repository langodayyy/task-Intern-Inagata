...
import EditProfile from "../components/custom/editProfil";
import { Preferences } from "../components/custom/preferences";
import { Security } from "../components/custom/security";
          ...
          <div className="inline-flex items-center justify-start border-b-2 border-[#F4F5F7] w-full ">
            <TabsList>
              <div className="flex md:gap-5 gap-0">
                <TabsTrigger value="editProfile" variant={"underline"}>
                  Edit Profile
                </TabsTrigger>
