...
function Navbar() {
  ...
  const pathToTitle = {
    ...
    "/loans": "Loans",
    "/services": "Services",
    "/myPrevileges": "My Privileges",
    "/settings": "Settings",
  };

  const title = pathToTitle[path] || "Page";
  ...
  const menuItems = [
    ...
    { label: "Credit Cards", path: "/creditCards" },
    { label: "Loans", path: "/loans" },
    { label: "Services", path: "/services" },
    { label: "My Privileges", path: "/myPrevileges" },
    { label: "Settings", path: "/settings" },
  ];

  return (
    <div className=" xl:ml-[250px] md:ml-[230px] xl:h-[100px] md:h-[85px] border-b-2  fixed top-0 left-0 right-0 z-50  bg-white border-[#E6EFF5] xl:px-10 md:px-[25px] md:py-5 p-[25px] pb-4 flex justify-between items-center ">
      <div className="md:hidden w-full flex-col flex  gap-5">
        <div className="flex justify-between w-full">
          <div className="relative ">
            <Sheet open={open} onOpenChange={setOpen}>
                ...
                >
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M18 13C18 13.5523 17.4801 14 16.8387 14L1.16129 14C0.519928 14 0 13.5523 0 13C0 12.4477 0.519928 12 1.16129 12L16.8387 12C17.4801 12 18 12.4477 18 13Z"
                      fill="#343C6A"
                    />
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M18 7C18 7.55228 17.5523 8 17 8L1 8C0.447716 8 0 7.55228 0 7C0 6.44771 0.447716 6 1 6L17 6C17.5523 6 18 6.44772 18 7Z"
                      fill="#343C6A"
                    />
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M18 1C18 1.55228 17.4801 2 16.8387 2L1.16129 2C0.519928 2 0 1.55229 0 1C0 0.447719 0.519928 0 1.16129 0L16.8387 0C17.4801 0 18 0.447714 18 1Z"
                      fill="#343C6A"
                    />
                  </svg>
                </Button>
              ...
              <SheetContent side="left" className="w-[60%] ">
                <div className="py-9 pl-6 pr-9 space-y-4">
                  {menuItems.map((item) => {
          ...
          <div className="xl:text-[28px] md:text-[25px] text-[20px] font-semibold text-[#343C6A] block md:hidden">
            {title}
          </div>
          <div className="w-[35px] h-[35px] rounded-full bg-[#F5F7FA] md:hidden">
            <img
              src="/images/pict.png"
              alt="Christina"
      ...
      <div className="xl:text-[28px] md:text-[25px] text-[20px] font-semibold text-[#343C6A] md:block hidden">
        {title}
      </div>
      <div className=" items-center xl:gap-[35px] md:gap-[25px] hidden md:flex">
        <div className="flex items-center xl:gap-[30px] md:gap-3">
          <SearchInput></SearchInput>

          <div className="p-3 bg-[#F5F7FA] rounded-full ">
            <svg
              className="w-[18px] h-[18px] md:w-[18px] md:h-[18px] xl:w-[25px] xl:h-[25px]"
              viewBox="0 0 25 25"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
        ...
        <div className="xl:w-[60px] xl:h-[60px] md:w-[45px] md:h-[45px] rounded-full bg-[#F5F7FA]">
          <img
            src="/images/pict.png"
            alt="Christina"
            className="w-full h-full rounded-full object-cover object-center "
