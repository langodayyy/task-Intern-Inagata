...
function Sidebar() {
  return (
    <div className="bg-white xl:w-[250px] md:w-[230px] w-[180px] min-h-screen border-[#E6EFF5] border-r-2 fixed">
      <div className="xl:h-[100px] md:h-[85px] h-12 w-full flex items-center md:justify-center justify-start gap-[9px]">
        <svg
        ...
        <div className="font-mont md:text-[25px] text-base font-bold font-mont-heavy text-[#343C6A] flex items-center justify-center h-full">
          Bankku.
        </div>
      </div>
      <div className="pt-[9px] w-full">
        <SidebarItem
          ...
          icon={
            <svg
              className="w-[20px] h-[20px] md:w-[20px] md:h-[20px] xl:w-[25px] xl:h-[25px]"
              viewBox="0 0 25 25"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
